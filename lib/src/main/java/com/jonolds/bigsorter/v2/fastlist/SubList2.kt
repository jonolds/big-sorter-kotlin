...
internal open class SubList2<E>(list: AbstractFastList2<E>, fromIndex: Int, toIndex: Int) : AbstractFastList2<E>() {


	private val l: AbstractFastList2<E> = list
	private val offset: Int = fromIndex
