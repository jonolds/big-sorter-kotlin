...
public class ArrayList<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
    ...
    /**
     * Save the state of the <code>ArrayList</code> instance to a stream (that
     * is, serialize it).
     *
     * @serialData The length of the array backing the <code>ArrayList</code>
...
//        }
    ...
    public List<E> subList(int fromIndex, int toIndex) {
        ...
        return new SubLest(this, 0, fromIndex, toIndex);
    }
    ...
    private class SubLest extends AbstractList<E> implements RandomAccess {
        ...
        public ListIterator<E> listIterator(final int index) {
            ...
            return new ListIterator<E>() {
                ...
                public void forEachRemaining(Consumer<? super E> consumer) {
                    Objects.requireNonNull(consumer);
                    final int size = SubLest.this.size;
                    int i = cursor;
                    if (i >= size) {
                        return;
                    }
        ...
        public List<E> subList(int fromIndex, int toIndex) {
            subListRangeCheck(fromIndex, toIndex, size);
            return new SubLest(this, offset, fromIndex, toIndex);
        }
